...
import { Image, Pressable, useColorScheme,Button } from "react-native";
import { StatusBar } from "expo-status-bar";
import Payments from "./screens/drawerScreens/Payments";

// manageing all the navigation stuff here in this file 
...
function TabsGroup({ navigation }) { // it will return a navigation container which contains tabs that we want in our application 
    return (
        <Tab.Navigator
            screenOptions={({ route }) => ({
